global com, POST, maxsr, ld0, ld1, ld2, ld3, ld4, ld5, ld6, ld7, ld8, ld9, ld10, ld11, fVoff, R, G, B, iR, iG, iB, tiR, tiG, tiB, nwR, nwG, nwB, sR, sG, sB, mR, mG, mB, port, psyon
psyon=0
com='COM3'
...
datar=30 #incoming number of values per second per channel
